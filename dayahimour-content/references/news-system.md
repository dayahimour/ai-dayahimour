...
### ملاحظات الحقول
- **sourceUrl**: ضع رابط المصدر الأصلي الكامل دائماً (مثال: `"https://www.cnbc.com/..."`).
  - عند عدم وجود `articleSlug`: الضغط على الخبر يفتح رابط المصدر في تبويب جديد
  - عند وجود `articleSlug`: الضغط على الخبر يفتح المقالة الداخلية، واسم المصدر يظهر كنص فقط (sourceUrl لا يُعرض كرابط)
...
| 5 | `sourceUrl` | رابط المصدر الأصلي الكامل (URL حقيقي) |
