...
### ملاحظات الحقول
- **publishedAt**: تاريخ ووقت نشر الخبر على الموقع (صيغة ISO مثل `"2026-04-25T14:30"`). يُستخدم لعداد "منذ كم" في البطاقة. إذا لم يُحدد، يُرجع لـ `date`. **أضفه دائماً** لتشغيل العداد من لحظة النشر الفعلية للمصداقية.
