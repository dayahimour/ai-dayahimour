...
| المعيار | Kimi K2.5 | GPT-5.4 Pro | Claude Opus 4.6 | Gemini 3.1 Pro |
|---------|-----------|-------|-----------------|----------------|
| **SimpleBench (منطق)** | 72.1% | 74.1% | 67.6% | 79.6% |
| **SWE-bench (برمجة)** | 64.2% | 76.9% | 78.7% | 75.6% |
| **GPQA Diamond (علوم)** | 74.5% | 91.4% | 90.5% | 94.1% |
