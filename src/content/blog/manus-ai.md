...
## عودة مفاجئة: الصين تلغي الصفقة وتعيد رسم الخريطة

في 27 أبريل 2026، أصدرت اللجنة الوطنية للتنمية والإصلاح الصينية (NDRC) قرارًا نهائيًا بـ **منع صفقة استحواذ "ميتا" على Manus** بالكامل، مبددةً بذلك أشهرًا من التكامل الاستراتيجي. استند القرار إلى "حماية الأمن القومي ومنع تسرب التقنيات الاستراتيجية"، في خطوة غير مسبوقة ضد شركة أمريكية عملاقة.

بموجب القرار، أُجبرت "ميتا" على إعادة هيكلة استثماراتها على الفور وفك دمج فريق Manus الذي كان يعمل تحت إدارتها. تراجعت أسهم "ميتا" بنحو 8% خلال ساعات من الإعلان، فيما تضاربت التحليلات حول مصير المنصة المستقبلي: هل ستعود Manus للعمل كشركة مستقلة في الصين، أم ستبحث عن شريك استراتيجي جديد؟

يُعد هذا الإلغاء منعطفًا حاسمًا في مسار Manus، حيث تبدو الآن المقالة بحاجة لتحديث مستمر مع تطور الأحداث.
