...
description: "دليل شامل: نموذج مفتوح المصدر بـ196 مليار معامل يفعّل 11 مليار فقط لكل توكن، يحقق أداءً متقدماً في الاستدلال والمهام الوكيلة بسرعة تصل إلى 350 توكن في الثانية، ويُقدّم تكلفة API منخفضة تجعله منافساً مباشراً لنماذج الـFlash الغربية. - اكتشف أهم التفاصيل والمقارنات التي تحتاجها."
date: "2026-04-05"
category: "نماذج"
