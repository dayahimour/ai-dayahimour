...
| **DeepSeek V4** | DeepSeek (الصين) | 3 مارس 2026 | 128K | مفتوح المصدر |
...
### ⚫ DeepSeek V4 — الصدمة القادمة من الصين

أطلق في **3 مارس 2026** بـ**تريليون معامل** مفتوح المصدر — ويعمل منها 32 مليار فقط في كل استدعاء عبر بنية Mixture-of-Experts. معماريته MODEL1 تحقق **40% تقليل في استخدام الذاكرة** و**1.8x تسريع في الاستنتاج**.
